"""Dataset loader para Experiment_9: Frequency masking."""
...
class Prop9DatasetLoader(BaseVisTuringDatasetLoader):
    """Dataset loader para Experiment_9 (frequency masking)."""

    EXPERIMENT_NAME = "Experiment_9"

    def __init__(self, data_path: Optional[str] = None):
        super().__init__(name="Prop9_FrequencyMasking", data_path=data_path)

    def load_data(self) -> tuple[dict, dict, np.ndarray]:
        """
        Carga las imágenes y metadatos del Experiment_9.

        Returns:
            Tupla (gabors, bgs, contrasts):
                - gabors: Dict con arrays de gabor patterns con máscaras de frecuencia
        ...
        # Cargar gabor patterns con máscaras de frecuencia
        # Formato: gabor_a_C1_Fmask_1p5.npy, gabor_a_C1_Fmask_3.npy, etc.
        gabors = {}
...
class Prop9Dataset(Dataset):
    """PyTorch Dataset para Experiment_9."""

    def __init__(
        self,
        gabor_key: str,  # ej: 'a_C1_Fmask_1p5' o 'all'
...
class Prop9TorchDatasetLoader(BaseVisTuringTorchDatasetLoader, Prop9DatasetLoader):
    """Torch DataLoader para Experiment_9."""

    def __init__(
        self,
        gabor_key: str = "a_C1_Fmask_1p5",  # Clave del gabor pattern o 'all'
        batch_size: int = 32,
        shuffle: bool = False,
        num_workers: int = 2,
        ...
        Prop9DatasetLoader.__init__(self, data_path=data_path)
        self.gabor_key = gabor_key
    ...
    def get_dataset(self, transform: Optional[Callable[[Any], Any]] = None) -> Dataset:
        ...
        mask_labels = ["nomask", "1p5", "3", "6", "12", "24"]
