"""Dataset loader para Experiment_10: Orientation masking."""
...
class Prop10DatasetLoader(BaseVisTuringDatasetLoader):
    """Dataset loader para Experiment_10 (orientation masking)."""

    EXPERIMENT_NAME = "Experiment_10"

    def __init__(self, data_path: Optional[str] = None):
        super().__init__(name="Prop10_OrientationMasking", data_path=data_path)

    def load_data(self) -> tuple[dict, dict, np.ndarray]:
        """
        Carga las imágenes y metadatos del Experiment_10.

        Returns:
            Tupla (gabors, bgs, contrasts):
                - gabors: Dict con arrays de gabor patterns con máscaras de orientación
        ...
        # Cargar gabor patterns con máscaras de orientación
        # Formato: gabor_a_C1_Omask_0.npy, gabor_a_C1_Omask_22p5.npy, etc.
        gabors = {}
...
class Prop10Dataset(Dataset):
    """PyTorch Dataset para Experiment_10."""

    def __init__(
        self,
        gabor_key: str,  # ej: 'a_C1_Omask_0' o 'all'
...
class Prop10TorchDatasetLoader(BaseVisTuringTorchDatasetLoader, Prop10DatasetLoader):
    """Torch DataLoader para Experiment_10."""

    def __init__(
        self,
        gabor_key: str = "a_C1_Omask_0",  # Clave del gabor pattern o 'all'
        batch_size: int = 32,
        shuffle: bool = False,
        num_workers: int = 2,
        ...
        Prop10DatasetLoader.__init__(self, data_path=data_path)
        self.gabor_key = gabor_key
    ...
    def get_dataset(self, transform: Optional[Callable[[Any], Any]] = None) -> Dataset:
        ...
        mask_labels = ["nomask", "0", "22p5", "45", "67p5", "90", "112p5", "135"]
